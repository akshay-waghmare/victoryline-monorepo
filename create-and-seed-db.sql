-- Create live_events table and seed dummy data
USE cricket_db;
...
-- Add some more events for IPL final
INSERT INTO live_events (match_id, message, event_type, over_label, innings_label, created_at) VALUES
('IPL_2025_FINAL', '🏏 IPL 2025 Final begins!', 'start', NULL, NULL, DATE_SUB(NOW(), INTERVAL 2 HOUR)),
('IPL_2025_FINAL', 'Toss won by Mumbai Indians, chose to bat first', 'info', NULL, NULL, DATE_SUB(NOW(), INTERVAL 115 MINUTE)),
('IPL_2025_FINAL', 'WICKET! Quick breakthrough for CSK', 'wicket', '3.1', '1st innings', DATE_SUB(NOW(), INTERVAL 105 MINUTE)),
('IPL_2025_FINAL', 'SIX! Huge hit into the stands!', 'boundary', '8.4', '1st innings', DATE_SUB(NOW(), INTERVAL 90 MINUTE)),
('IPL_2025_FINAL', 'Strategic timeout. MI 89/2', 'info', '10.0', '1st innings', DATE_SUB(NOW(), INTERVAL 80 MINUTE)),
('IPL_2025_FINAL', 'FOUR! Elegant shot to the boundary', 'boundary', '12.3', '1st innings', DATE_SUB(NOW(), INTERVAL 70 MINUTE)),
('IPL_2025_FINAL', 'WICKET! Another one bites the dust', 'wicket', '14.2', '1st innings', DATE_SUB(NOW(), INTERVAL 60 MINUTE)),
('IPL_2025_FINAL', 'End of innings. MI 175/6', 'innings', '20.0', '1st innings', DATE_SUB(NOW(), INTERVAL 45 MINUTE));

SELECT '✅ Database and dummy data created successfully!' as Status;
SELECT COUNT(*) as TotalEvents FROM live_events;
SELECT match_id, COUNT(*) as EventCount FROM live_events GROUP BY match_id;
