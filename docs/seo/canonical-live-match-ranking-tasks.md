...
- [-] **R1.1** Select 3–9 controlled samples: at least one upcoming, live, and completed match with stable match identity and model eligibility.  
  ...
  Blocker: define and prove the remaining upcoming opening-model contract, then verify 390px browser hydration parity before freezing the three-lifecycle cohort.  
