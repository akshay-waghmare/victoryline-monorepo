...
- [-] **R1.1** Select 3–9 controlled samples: at least one upcoming, live, and completed match with stable match identity and model eligibility.  
  ...
  Blocker: pass a revised female temporal-calibration holdout and safely publish an exact opening-model row for the selected upcoming identity before freezing the three-lifecycle cohort.  
