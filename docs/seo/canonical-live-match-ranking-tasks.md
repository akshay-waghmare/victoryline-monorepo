...
**Current active tasks: R1.1, R1.3, R1.4, R2.5, and R3.1 — complete the remaining upcoming cohort contract, maintain live/completed evidence as the catalogue rotates, then prove analytics receipt and GSC outcomes.** R0.6 and R4.2 are live and verified. The current readiness guard marks live BP-W/WF-W and completed BB/CS eligible with truthful canonical SSR intelligence; upcoming has no exact opening-model row. The offline Elo revision clears its statistical gate and Phase 1–3 ingress/serializer code is committed, but the current historical artifact ends 2026-07-02 and correctly refuses the August fixture as too old. Do not claim indexing or ranking improvement until the three-lifecycle cohort and outcome gates pass.
...
- [-] **R1.1** Select 3–9 controlled samples: at least one upcoming, live, and completed match with stable match identity and model eligibility.  
  ...
  Blocker: refresh the historical T20 input/artifact to a sufficiently recent as-of date, deploy the isolated scraper/dashboard handoff, and safely publish one exact opening-model row for the selected upcoming identity before freezing the three-lifecycle cohort.  
