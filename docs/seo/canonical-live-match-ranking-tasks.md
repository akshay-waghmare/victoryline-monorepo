...
- [-] **R4.3** Ensure retained completed matches link to teams, series, and next relevant match.
  ...
  Remaining proof: narrow frontend build, production raw SSR evidence of the three link classes for a retained completed URL, and HTTP 200 checks for each emitted entity route.
