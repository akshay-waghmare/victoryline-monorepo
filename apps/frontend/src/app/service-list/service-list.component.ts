...
export class ServiceListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.footballService.getUpcomingFootballEvents().subscribe((data) => {
      console.log(data);
       const result = _.toArray(data);
      this.groupedByLeaguesUpcoming =  _.groupBy(result, (obj) => obj.country_leagues);
    ...
    this.footballService.getInplayFootballEvents().subscribe((data) => {
      ...
      this.groupedByLeagesInplay =  _.groupBy(this.result, (obj) => obj.country_leagues);
    });
